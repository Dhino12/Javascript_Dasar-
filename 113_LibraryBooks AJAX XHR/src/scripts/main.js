...
function main() {
    ...
    const insertBook = (book) => {
        ...
        // membuat POST request dan menetapkan URL
        ...
        // mengirimkan request dan menyiapkan JSON.stringify(book) pada body
    ...
    const updateBook = (book) => {
        ...
        // mengirim request dan menyisipkan JSON.stringify(book) pada body
        xhr.send(JSON.stringify(book));
    };
